...
class TextModel
{
	...
	private SubModel GetTextSubModelForStyle(Style style)
	{
		...
		// mat.shader = GUI.the.materialManager.get("default").shader; // Material.builtIn.shader;
		textModel.material = style.background.manager.declare();
		textModel.material.shader = style.background.shader;
		textModel.material.texture = style.font.fontMap;
		return textModel;
	}

module gui.widgetfeature.gridlayout;
...
{	
	...
	override protected void layout(Widget widget, bool fit)
	{
		...
		float scaleFlexWidth  = (rect.w - fixedWidth ) / (accumWidth - fixedWidth);
		float scaleFlexHeight = (rect.h - fixedHeight) / (accumHeight - fixedHeight);

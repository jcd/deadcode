...
//	Variant data;
	...
	void deserialize(string str)
	{
		...
		auto result = str.findSplit("\r\n");
		if (result[1].empty)
		{
			result = str.findSplit("\n");
			if (result[1].empty)
				throw new Exception("Error deserializing type of GenericResource");
		}

		auto typeName = result[0];
